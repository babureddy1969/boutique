...
public class PaymentAdapter extends RecyclerView.Adapter<PaymentAdapter.ItemHolder> {
    ...
    public PaymentAdapter.ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_payments, parent, false);
    ...
    class ItemHolder extends RecyclerView.ViewHolder {
        ...
        ItemHolder(View itemView) {
            super(itemView);
            mItem = itemView.findViewById(R.id.rl_custom_layout_payments);
